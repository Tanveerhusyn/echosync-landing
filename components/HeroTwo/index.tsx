...
export default function HeroTwo() {
  ...
  return (
    <div className="relative flex w-full flex-col">
      ...
      <div className="absolute inset-0 -z-1  h-[600px] w-full bg-transparent bg-[linear-gradient(to_right,#f0f0f0_1px,transparent_1px),linear-gradient(to_bottom,#f0f0f0_1px,transparent_1px)] bg-[size:6rem_4rem] opacity-10 [mask-image:radial-gradient(ellipse_80%_50%_at_50%_0%,#000_70%,transparent_110%)]"></div>
      <nav className="relative mx-auto w-full items-center px-4 pt-5 sm:px-8 md:space-x-6 lg:flex">
        ...
        >
          ...
          <li className="order-2 py-5 md:py-0">
            <button className="font-geist inline-flex h-12 items-center justify-center rounded-md border border-gray-800 bg-gradient-to-t from-[#8678f9] from-0% to-[#c7d2fe] px-6 font-medium text-gray-950 transition-colors focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-gray-50 ">
              Get Started
            </button>
          </li>
        </ul>
      </nav>
      <section className="z-10 py-28">
        <div className="mx-auto max-w-screen-xl items-center justify-between gap-x-12 overflow-hidden text-gray-600 md:flex md:px-8">
          <div className="flex-none space-y-5 px-4 sm:max-w-lg md:px-0 lg:max-w-xl">
            <h1 className="font-geist  group mr-auto w-fit rounded-3xl border-[2px] border-white/5 bg-gradient-to-tr from-zinc-300/5 via-gray-400/5 to-transparent  px-5 py-2 text-sm text-gray-400">
              Over 200+ deals finished
              <ChevronRight className="ml-2 inline h-4 w-4 duration-300 group-hover:translate-x-1" />
            </h1>
            <h2 className="font-geist bg-[linear-gradient(180deg,_#FFF_0%,_rgba(255,_255,_255,_0.00)_202.08%)] bg-clip-text text-4xl font-normal tracking-tighter text-transparent md:text-5xl lg:text-5xl">
        ...
        <div className="mt-14 px-4 md:px-8">
          <p className="font-displayAlt text-center text-sm font-semibold text-gray-700">
